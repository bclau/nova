    ...
    def monitor(self, callback):
        ...
        try:
            ...
            try:
                ...
                LOG.error("Exception durring failover callback: %s", e)
            if vm_name:
...
# TODO(claudiub): this will have to be removed when the fix merges into the
#                 official WMI module repo.
