...
class VMOps(object):
    ...
    def create_instance(self, instance, network_info, block_device_info,
        ...
        controller = constants.VM_GENERATIONS_CONTROLLERS[vm_gen]
