...
class VMOps(object):
    ...
    def _soft_shutdown(self, instance,
        ...
        while timeout > 0:
            ...
            # Wait maximum retry_interval for the instance to be shutdown.
            # If it was not shutdown, retry until it succeded or a maximum of
            # time waited is equal to timeout.
            wait_time = retry_interval if retry_interval < timeout else timeout
            try:
                ...
                LOG.warning(_LW("Soft shutdown failed: %s"), e,
                            instance=instance)
