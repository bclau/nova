...
class HostUtilsTestCase(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self._conn_cimv2 = self._hostutils._conn_cimv2 = mock.MagicMock()
    ...
    def test_get_cpus_info(self):
        ...
        self._conn_cimv2.query.return_value = [cpu]
    ...
    def test_get_memory_info(self):
        ...
        self._conn_cimv2.query.return_value = [memory]
    ...
    def test_get_volume_info(self):
        ...
        self._conn_cimv2.query.return_value = [disk]
        (total_memory,
    ...
    def _test_check_min_windows_version(self, version, expected):
        os = mock.MagicMock()
        os.Version = version
        self._conn_cimv2.Win32_OperatingSystem.return_value = [os]
