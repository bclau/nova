...
class BaseVolumeUtilsTestCase(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self._mock_winreg = mock.MagicMock()
        self._wmi_patcher = mock.patch.dict(sys.modules, wmi=self._mock_wmi)
        self._winreg_patcher = mock.patch.dict(sys.modules,
                                               _winreg=self._mock_winreg)
    ...
    def tearDown(self):
        ...
        super(BaseVolumeUtilsTestCase, self).tearDown()
    ...
    def test_get_iscsi_initiator_exception(self):
        self._test_get_iscsi_initiator(self._mock_winreg,
                                       _exception_thrower,

                                       self._FAKE_INITIATOR_IQN_NAME)

    def _test_get_iscsi_initiator(self, mock_winreg, winreg_method, expected):
